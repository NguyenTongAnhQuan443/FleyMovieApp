...
class NewlyUpdatedMovies {
  bool? status;
  List<Items>? items;
  Pagination? pagination;

  NewlyUpdatedMovies({this.status, this.items, this.pagination});

  NewlyUpdatedMovies.fromJson(Map<String, dynamic> json) {
...
class Items {
  ...
  Items({this.modified, this.id, this.name, this.slug, this.originName, this.posterUrl, this.thumbUrl, this.year});
